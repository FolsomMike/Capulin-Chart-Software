...
public class SyncedBoolean extends SyncedVariable{


    private boolean value;

//-----------------------------------------------------------------------------
// SyncedBoolean::SyncedBoolean (constructor)
//
...
public SyncedBoolean(SyncedVariableSet pSyncedVariableSet)
{

    super(pSyncedVariableSet);

}//end of SyncedBoolean::SyncedBoolean (constructor)
//-----------------------------------------------------------------------------
...
}//end of SyncedBoolean::applyValue
//-----------------------------------------------------------------------------
...
}//end of SyncedBoolean::getValue
//-----------------------------------------------------------------------------


}//end of class SyncedBoolean
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
