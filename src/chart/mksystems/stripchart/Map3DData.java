/******************************************************************************
* Title: Map3DData.java
* Author: Mike Schoonover
* Date: 9/30/13
*
* Purpose:
*
* This class handles data for a 3D map. It has synchronized functions (or other
...
// class Map3DData
//
// This class creates and controls a data set for a 3D map.
//

public class Map3DData extends PlotterData{

    int mapDataBuffer[][];

//-----------------------------------------------------------------------------
// Map3DData::Map3DData (constructor)
//
//

public Map3DData(final int pBufferSize, int pWidthOfDataBuffer,
...
}//end of Map3DData::Map3DData (constructor)
//-----------------------------------------------------------------------------
...
}//end of Map3DData::resetAll
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::storeDataAtInsertionPoint
//
...
}//end of Map3DData::storeDataAtInsertionPoint
//-----------------------------------------------------------------------------
...
}//end of Map3DData::clearFlags
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::getNewData
//
...
synchronized public int getNewData(Map3DDatum pDatum)
{
...
}//end of Map3DData::advanceInsertionPoint
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::getMapDataBuffer
//
...
}//end of Map3DData::getMapDataBuffer
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::saveSegment
//
...
}//end of Map3DData::saveSegment
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::loadSegment
//
...
}//end of Map3DData::loadSegment
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::processDataSeries
//
...
}//end of Map3DData::processDataSeries
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::prepareForRepaint
//
...
}//end of Map3DData::prepareForRepaint
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::getDataAtRepaintPoint
//
// Returns the data and flags at the buffer location of repaintPoint. Advances
// repaintPoint to the next position.
//

public int getDataAtRepaintPoint(Map3DDatum pDatum){
...
}//end of Map3DData::getDataAtRepaintPoint
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
// Map3DData::advanceRepaintPoint
//
...
}//end of Map3DData::advanceRepaintPoint
//-----------------------------------------------------------------------------


}//end of class Map3DData
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------